		...
		<header>
			...
			<aside>
                ...
                <p class="h1a"> 6 gwiazdek w przewodniku Michelin. <br> Nasz hotel spełnia najwyższe standardy we wszystkich dziedzinach. Niejednokrotnie w naszym hotelu gościł Mr. John Wick.<br> - znany szerzej jako Keanu Reeves<br><br></p>
                    <div>
        <h1> POKOJE: </h1>
        <form method="get" action="wynik.php">
       <p> Metoda wyszukania : <select name="metoda">
            <option value="pokoj"> Pokoj</option>
            <option value="dni"> Liczba dni</option>
            <option value="osoby"> Liczba osób</option>  
            </select> </p><br>
            
        <p> Nazwa/ilość: <input type="text" name="wyrazenie"> </p>
         <br>   
